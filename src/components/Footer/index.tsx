...
const list = [
  { h4: "Company", li: ["About", "Features", "Works", "Career"] },
  { h4: "Help", li: ["Customer Support", "Delivery Details", "Terms & Conditions", "Privacy Policy"] },
  { h4: "FAQ", li: ["Account", "Manage Deliveries", "Orders", "Payments"] },
  { h4: "Resources", li: ["Free Ebooks", "Development Tutorial", "How-to Blog", "YouTube Playlist"] }
];
      ...
      <div className={styles.container}>
        <div className={styles.about}>
          ...
          <div className={styles.social}>
            ...
            <a href="#" aria-label="Threads"><i className="bi bi-threads-fill"></i></a>
        ...
        <div className={styles.bottom}>
          <span className={styles.copy}>Shop.co © 2000–2025, All Rights Reserved</span>
